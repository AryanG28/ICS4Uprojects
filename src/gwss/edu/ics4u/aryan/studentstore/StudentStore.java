...
public class StudentStore {
    ...
    public StudentStore(int OEN, String firstName, String lastName, School School, int studentId, int height, int gender, boolean IEP, double average, String secretComment) {
    ...
    public StudentStore(int OEN, String firstName, String lastName, School School) {
        this();
        this.OEN = OEN;
    ...
    public boolean equals(Object obj) {
        ...
        final StudentStore other = (StudentStore) obj;
