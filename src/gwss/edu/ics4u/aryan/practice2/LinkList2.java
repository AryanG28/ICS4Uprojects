...
public class LinkList2 {
  ...
  //  @Override
   ...
   // @Override
    ...
    public Node2 getPrevious(Node2 n) {
        Node2 n1 = this.head;
        ...
        System.out.print("Error unable to find node");
        return null;
    }
    //    @Override
...
//    }
    public static void main(String[] args) {
        ...
        d.setFirstName("Aryan");
        e.setLastName("Khaledi");
